...
export class PermissionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('smartinumApp.permission.delete.question'));
...
export default class PermissionComponentsPage {
  ...
  async deletePermission() {
    ...
    expect(await permissionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/smartinumApp.permission.delete.question/);
