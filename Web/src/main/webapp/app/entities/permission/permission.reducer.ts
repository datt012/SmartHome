...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PERMISSION: 'permission/PARTIAL_UPDATE_PERMISSION',
...
export default (state: PermissionState = initialState, action): PermissionState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PERMISSION):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PERMISSION):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PERMISSION):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPermission> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PERMISSION,
