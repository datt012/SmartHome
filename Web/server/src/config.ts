...
export class Config {
  debugLogging = 'debug';
  'server.port' = '3000';
  'jhipster.clientApp.name' = 'smartinum';
  ...
  'jhipster.mail.from' = 'smartinum@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'smartinum API';
  'jhipster.swagger.description' = 'smartinum API documentation';
  ...
  'eureka.instance.appname' = 'smartinum';
  'eureka.instance.instanceId' = 'smartinum:${random.value}';
